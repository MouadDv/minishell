...
NAME = minishell
LIBFT = libft.a
SRCS = main.c env_strct.c scan.c print_strct.c parser.c parser_utils.c parser_utils2.c parser_utils3.c data_proccessing.c data_proccessing_utils.c free.c
...
VALGRIND= -lreadline -L /usr/local/opt/readline/lib -I /usr/local/opt/readline/include -Wall -Wextra -Werror
rm = rm -f
CC = gcc
